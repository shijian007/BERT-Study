...
## Required parameters
flags.DEFINE_string(
    "data_dir", "/Users/xiezhijun/Desktop/Gaodun/Machine Learning/ML JOB/BERT/BERT-Classification-Tutorial/data",
    "The input data dir. Should contain the .tsv files (or other data files) "
    "for the task.")

flags.DEFINE_string(
    "bert_config_file", "/Users/xiezhijun/Desktop/Gaodun/Machine Learning/ML JOB/BERT/BERT-Classification-Tutorial/chinese_L-12_H-768_A-12/bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "testsort", "The name of the task to train.")

flags.DEFINE_string("vocab_file", "/Users/xiezhijun/Desktop/Gaodun/Machine Learning/ML JOB/BERT/BERT-Classification-Tutorial/chinese_L-12_H-768_A-12/vocab.txt",
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", "/Users/xiezhijun/Desktop/Gaodun/Machine Learning/ML JOB/BERT/BERT-Classification-Tutorial/output",
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", "/Users/xiezhijun/Desktop/Gaodun/Machine Learning/ML JOB/BERT/BERT-Classification-Tutorial/chinese_L-12_H-768_A-12/bert_model.ckpt",
...
#Processor for finance text classifier
class TextSortProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        """See base class."""
        file_path = os.path.join(data_dir, 'train_taxdata_0107_stopwords.csv')
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        file_path = os.path.join(data_dir, 'dev_taxdata_0107_stopwords.csv')
        with open(file_path, 'r') as f:
            reader = f.readlines()
        examples = []
        labels = []
